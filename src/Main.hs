...
-- pixelsComprimidosSiDiferente recibe una fila, una columna, dos listas de píxeles correspondientes a frames consecutivos
-- (que se encuentran en la fila y a partir de la columna indicadas), más un umbral.
...
-- Ejercicio 5/5
-- descomprimir toma un video comprimido y recompone los cambios de la compresión original.
